...
public class ToReturnDto {
    ...
    public ToReturnDto(String borrowId, String bookId, String memberId, Date returnDate) {
    ...
    public ToReturnDto(String memberId2, String memberName2, String bookId2, String bookName2, Date issueDate2,
            Date dueDate2) {
